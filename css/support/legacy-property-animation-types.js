...
// In general, each specification should define and test the animation behavior
// for each property it specifies.
//
// However, for specifications written before CSS transitions, CSS animations,
// and Web Animations, we define the animation types here.
//
// As these specifications are revised in future, tests for their properties
// should be moved to their corresponding test suites.
//
// The format for each property's animation type definition is an array of
// <type> objects where each type is either:
//
// * a 'type' string matching one of the types defined in
//   common-animation-types.js, e.g. 'color', or
//
// * an object with format:
//   {
//      type: string,         // As above, one of the common animation types
//
//      options?: any,        // Any additional parameters used by the animation
//                            // type's test function to setup the test.
//                            // Optional.
//
//      setup?: t => Element, // An optional function that takes the Test object
//                            // as an argument (so it can register a cleanup
//                            // function) and creates and returns a suitable
//                            // element for applying the test animation to.
//   }

// TODO: Tidy up the rest of this... why are there some properties with
// nothing???

const legacyCSSPropertyAnimationTypes = {
  'align-content': {
    // https://drafts.csswg.org/css-align/#propdef-align-content
    types: [{ type: 'discrete', options: [['flex-start', 'flex-end']] }],
  },
  'align-items': {
  ...
  'background-attachment': {
    ...
    types: [{ type: 'discrete', options: [['fixed', 'local']] }],
  },
  'background-color': {
  ...
  'background-clip': {
    ...
    types: [{ type: 'discrete', options: [['padding-box', 'content-box']] }],
  },
  'background-image': {
  ...
  'border-bottom-style': {
    ...
    types: [{ type: 'discrete', options: [['dotted', 'solid']] }],
  },
  'border-bottom-width': {
  ...
  'border-collapse': {
    ...
    types: [{ type: 'discrete', options: [['collapse', 'separate']] }],
  },
  ...
  'border-image-outset': {
    ...
    types: [{ type: 'discrete', options: [['1 2 3 4', '5 6 7 8']] }],
  },
  'border-image-repeat': {
    // https://drafts.csswg.org/css-backgrounds-3/#border-image-repeat
    types: [{ type: 'discrete', options: [['stretch repeat', 'round space']] }],
  },
  'border-image-slice': {
  ...
  'box-decoration-break': {
    ...
    types: [{ type: 'discrete', options: [['slice', 'clone']] }],
  },
  'box-shadow': {
  ...
  'caption-side': {
    ...
    types: [{ type: 'discrete', options: [['top', 'bottom']] }],
  },
  'caret-color': {
  ...
  clear: {
    ...
    types: [{ type: 'discrete', options: [['left', 'right']] }],
  },
  clip: {
    ...
    types: [
      'rect',
      {
        type: 'discrete',
        options: [
          ['rect(10px, 10px, 10px, 10px)', 'auto'],
          ['rect(10px, 10px, 10px, 10px)', 'rect(10px, 10px, 10px, auto)'],
        ],
      },
    ],
  },
  ...
  'clip-rule': {
    ...
    types: [{ type: 'discrete', options: [['evenodd', 'nonzero']] }],
  },
  color: {
  ...
  'column-fill': {
    ...
    types: [{ type: 'discrete', options: [['auto', 'balance']] }],
  },
  'column-rule-style': {
  ...
  'column-width': {
    ...
    types: ['length', { type: 'discrete', options: [['auto', '1px']] }],
  },
  content: {
    // https://drafts.csswg.org/css-content-3/#propdef-content
    types: [{ type: 'discrete', options: [['"a"', '"b"']] }],
    setup: t => {
  ...
  'counter-increment': {
    ...
    types: [{ type: 'discrete', options: [['ident-1 1', 'ident-2 2']] }],
  },
  'counter-reset': {
  ...
  cursor: {
    ...
    types: [{ type: 'discrete', options: [['pointer', 'wait']] }],
  },
  'dominant-baseline': {
    // https://drafts.csswg.org/css-inline/#propdef-dominant-baseline
    types: [{ type: 'discrete', options: [['ideographic', 'alphabetic']] }],
  },
  'empty-cells': {
    // https://drafts.csswg.org/css-tables/#propdef-empty-cells
    types: [{ type: 'discrete', options: [['show', 'hide']] }],
  },
  fill: {
  ...
  'flex-direction': {
    ...
    types: [{ type: 'discrete', options: [['row', 'row-reverse']] }],
  },
  'flex-grow': {
  ...
  'flex-wrap': {
    ...
    types: [{ type: 'discrete', options: [['nowrap', 'wrap']] }],
  },
  'flood-color': {
  ...
  'font-style': {
    ...
    types: [{ type: 'discrete', options: [['italic', 'oblique']] }],
  },
  float: {
  ...
  'font-synthesis': {
    ...
    types: [{ type: 'discrete', options: [['none', 'weight style']] }],
  },
  ...
  'font-variant-caps': {
    ...
    types: [{ type: 'discrete', options: [['small-caps', 'unicase']] }],
  },
  ...
  'font-variant-numeric': {
    ...
    types: [{ type: 'discrete', options: [['lining-nums', 'oldstyle-nums']] }],
  },
  'font-variant-position': {
    // https://drafts.csswg.org/css-fonts-3/#propdef-font-variant-position
    types: [{ type: 'discrete', options: [['sub', 'super']] }],
  },
  'font-variation-settings': {
    ...
    types: [
      ...
      {
        type: 'discrete',
        options: [['"wght" 1.1, "wdth" 1', '"wdth" 5'], ['"wdth" 5', 'normal']],
      },
    ],
  },
  'font-weight': {
  ...
  'grid-auto-columns': {
    ...
    types: [{ type: 'discrete', options: [['1px', '5px']] }],
  },
  'grid-auto-flow': {
    // https://drafts.csswg.org/css-grid/#propdef-grid-auto-flow
    types: [{ type: 'discrete', options: [['row', 'column']] }],
  },
  'grid-auto-rows': {
  ...
  'grid-column-end': {
    ...
    types: [{ type: 'discrete', options: [['1', '5']] }],
  },
  'grid-column-gap': {
  ...
  'grid-template-areas': {
    ...
    types: [{ type: 'discrete', options: [['". . a b" ". .a b"', 'none']] }],
  },
  height: {
  ...
  hyphens: {
    ...
    types: [{ type: 'discrete', options: [['manual', 'none']] }],
  },
  'image-orientation': {
    // https://drafts.csswg.org/css-images-3/#propdef-image-orientation
    types: [{ type: 'discrete', options: [['none', 'from-image']] }],
  },
  'image-rendering': {
  ...
  'ime-mode': {
    ...
    types: [{ type: 'discrete', options: [['disabled', 'auto']] }],
  },
  'initial-letter': {
    // https://drafts.csswg.org/css-inline/#propdef-initial-letter
    types: [{ type: 'discrete', options: [['1 2', '3 4']] }],
  },
  'inline-size': {
  ...
  'text-combine-upright': {
    ...
    types: [{ type: 'discrete', options: [['all', 'none']] }],
  },
  ...
  'text-emphasis-position': {
    ...
    types: [{ type: 'discrete', options: [['over right', 'under left']] }],
  },
  'text-emphasis-style': {
    // http://dev.w3.org/csswg/css-text-decor-3/#propdef-text-emphasis-style
    types: [{ type: 'discrete', options: [['filled circle', 'open dot']] }],
  },
  'text-indent': {
  ...
  'vector-effect': {
    ...
    types: [{ type: 'discrete', options: [['none', 'non-scaling-stroke']] }],
  },
  'vertical-align': {
